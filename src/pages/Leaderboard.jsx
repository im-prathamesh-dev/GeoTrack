    ...
    <div className="p-6 md:p-10 pb-24 md:pb-10 max-w-4xl mx-auto min-h-full">
      ...
      {isEmpty ? (
        <div className="flex flex-col items-center justify-center mt-20 text-center">
          <div className="w-24 h-24 rounded-full bg-neutral-800/50 flex items-center justify-center mb-6 border border-white/5">
            <Trophy size={40} className="text-neutral-600" />
          </div>
          <h2 className="text-2xl font-bold text-white mb-2">No conquerors yet!</h2>
          <p className="text-neutral-400 max-w-sm">
            The world is waiting to be claimed. Head over to the Activity tab and be the first to capture some territory!
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="flex items-end justify-center gap-2 md:gap-4 mb-16 mt-12 px-2">
            ...
            >
              ...
              <p className="text-gray-400 text-xs font-semibold">{leaders[1]?.area || '0.00'} km²</p>
            ...
            >
              ...
              <p className="text-yellow-500 text-sm font-bold">{leaders[0]?.area || '0.00'} km²</p>
            ...
            >
              ...
              <p className="text-amber-600 text-xs font-semibold">{leaders[2]?.area || '0.00'} km²</p>
